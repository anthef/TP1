...
public class CustomerMenu extends MemberMenu{
    ...
    private Scene createTambahPesananForm() {
        ...
        Label restoNameLabel = new Label("Restaurant:");
        ...
        ArrayList<String> restoName = new ArrayList<>();
        ...
        menuLayout.getChildren().add(restaurantComboBox);
    ...
    private Scene createCekSaldoScene() {
        ...
        Label saldoLabel = new Label("Saldo: Rp " + saldoString);
    ...
    private void handleBuatPesanan(String namaRestoran, String tanggalPemesanan, List<String> menuItems) {
        ...
        Menu[] items = new Menu[menuItems.size()];
        int index = 0;
    ...
    private void handleBayarBill(String orderID, String pilihanPembayaran) {
        ...
        if(odr == null){
            ...
            if(user.getPaymentSystem() instanceof CreditCardPayment && (pilihanPembayaran.equals("Credit Card"))){
                ...
                else if(user.getPaymentSystem() instanceof DebitPayment && pilihanPembayaran.equals("Debit")){
